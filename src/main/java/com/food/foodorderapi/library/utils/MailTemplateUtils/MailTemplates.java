...
public final class MailTemplates {
    ...
    public String adminRemovedEmail(
            String appName,
            String supportEmail,
            String companyName,
            String companyAddress,
    ...
    <head>
      ...
      <meta name="color-scheme" content="light dark">
      <meta name="supported-color-schemes" content="light dark">
      <title>%1$s admin access removed</title>
      <style>
        html, body { margin:0 !important; padding:0 !important; height:100%% !important; }
        body { width:100%% !important; -webkit-text-size-adjust:100%%; -ms-text-size-adjust:100%%; }
        table, td { mso-table-lspace:0pt; mso-table-rspace:0pt; }
        ...
        <tr>
          <td align="center">
            <table role="presentation" cellpadding="0" cellspacing="0" class="container">
              ...
              <tr>
                <td class="center">
                  <img src="%5$s" width="140" height="40" alt="%1$s" style="display:block;">
                </td>
              </tr>
              <tr><td class="spacer-24">&nbsp;</td></tr>
              ...
              <tr>
                <td class="card px py">
                  <table role="presentation" width="100%%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h1 class="heading">Your admin access has been removed</h1>
                        <p class="body">
                          This is to inform you that your administrator access to <strong>%1$s</strong>
                          has been revoked. You can still sign in if you have a standard user account.
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        <p class="muted" style="margin:0;">
                          ...
                          <a href="mailto:%2$s" style="color:#2563eb;">%2$s</a>.
                        </p>
                      </td>
                    </tr>
                  </table>
